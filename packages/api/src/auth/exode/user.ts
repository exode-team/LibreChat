...
import type { ExodeExchangeUser, ExodeProfile } from './types';
...
function needsProfileUpdate(user: IUser, identity: ExodeProfile, email: string): boolean {
  return (
